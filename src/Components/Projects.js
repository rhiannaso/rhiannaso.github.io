    ...
    const projects = [
      {
        ...
        desc: "Tool that generates potential solutions for defective files by \
        ...
        techTxt: ["Python", "Coverity Static Analyis", "PyQt", "BeyondCompare"]
      },
      {
        title: "ReciPull",
        desc: "A web application that takes in a user-inputted list of ingredients (through \
